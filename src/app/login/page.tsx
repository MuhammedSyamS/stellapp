...
export default function LoginPage() {
  ...
  const handleVerifyOTP = () => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem('stellapp_token', 'mocked_jwt_token_syam');
    ...
    <div className="split-container">
      ...
      <div className="left-panel">
        ...
        <div className="login-form-container">
          <Link href="/" className="back-link" style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#6b7280', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 600, marginBottom: '2rem', transition: 'color 0.2s', alignSelf: 'flex-start' }}>
